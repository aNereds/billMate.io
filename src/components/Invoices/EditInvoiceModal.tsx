...
class EditInvoiceModal extends Component<EditInvoiceModalProps, EditInvoiceModalState> {
  constructor(props: EditInvoiceModalProps) {
    super(props);
    this.state = {
      formData: {
        company: props.invoice.company,
        amount: props.invoice.amount.toString(),
  ...
  validate = (): boolean => {
    ...
    const errors: EditInvoiceModalState['errors'] = {};
      ...
      <div className={styles.modal} onClick={this.handleClose}>
        <div className={styles.modal__content} onClick={(e) => e.stopPropagation()}>
          <div className={styles.modal__header}>
            <h2 className={styles.modal__title}>Edit Invoice</h2>
            <button
