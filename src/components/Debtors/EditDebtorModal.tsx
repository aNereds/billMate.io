...
interface EditDebtorModalState {
  formData: {
    companyName: string;
    country: string;
...
class EditDebtorModal extends Component<EditDebtorModalProps, EditDebtorModalState> {
  constructor(props: EditDebtorModalProps) {
    super(props);
    this.state = {
      formData: {
        companyName: props.debtor.companyName,
        country: props.debtor.country,
        registrationNumber: props.debtor.registrationNumber,
        creditLimit: props.debtor.creditLimit.toString(),
      },
      errors: {},
    };
  }
  ...
  validate = (): boolean => {
    ...
    const errors: EditDebtorModalState['errors'] = {};
      ...
      <div className={styles.modal} onClick={this.handleClose}>
        <div className={styles.modal__content} onClick={(e) => e.stopPropagation()}>
          <div className={styles.modal__header}>
            <h2 className={styles.modal__title}>Edit Debtor</h2>
            <button
